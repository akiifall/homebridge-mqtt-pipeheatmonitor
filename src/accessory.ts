...
export = (api: API) => {
  hap = api.hap;
  api.registerAccessory("PipeHeaterMonitor", PipeHeaterMonitor);
};

class PipeHeaterMonitor implements AccessoryPlugin {
  ...
  constructor(log: Logging, config: AccessoryConfig, api: API) {
    ...
    this.deviceService.setCharacteristic(this.api.hap.Characteristic.ValveType, 0);
